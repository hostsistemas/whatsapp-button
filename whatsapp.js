function carregaCSS(){
	...
	var link = document.createElement( "link" );
        link.href   = "https://github.com/lucianobragaweb/whatsapp-button/style.css";
        link.type   = "text/css";
        link.rel    = "stylesheet";
...
function getInfo(info) {
    var script = document.querySelectorAll("script[src='https://github.com/lucianobragaweb/whatsapp-button/whatsapp.js']");
